...
- Generate the system & architecture documentation, including
  ...
  - database schema
  - If there are critical & complex part, you can create specific documentation around certain parts (optional)too
- Then update the README.md, make sure you include an index of all documentation created in .agent, so
  anyone can just look at README.md to get full understanding of where to look for what information
...
Please include Related doc section, clearly list out relevant docs to read for full context I
